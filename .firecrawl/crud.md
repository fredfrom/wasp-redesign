[Skip to main content](https://wasp.sh/docs/data-model/crud#__docusaurus_skipToContent_fallback)
...
With a single declaration, you can tell Wasp to automatically generate server-side logic (i.e., Queries and Actions) for creating, reading, updating and deleting [Entities](https://wasp.sh/docs/data-model/entities). As you update definitions for your Entities, Wasp automatically regenerates the backend logic.

Early preview

This feature is currently in early preview and we are actively working on it. Read more about [our plans](https://wasp.sh/docs/data-model/crud#future-of-crud-operations-in-wasp) for CRUD operations.

## Overview [​](https://wasp.sh/docs/data-model/crud\#overview "Direct link to Overview")
...
![Automatic CRUD with Wasp](https://wasp.sh/img/crud_diagram.png)Visualization of the Tasks crud declaration

We can now use the CRUD queries and actions we just specified in our client code.

Keep reading for an example of Automatic CRUD in action, or skip ahead for the [API Reference](https://wasp.sh/docs/data-model/crud#api-reference).

## Example: A Simple TODO App [​](https://wasp.sh/docs/data-model/crud\#example-a-simple-todo-app "Direct link to Example: A Simple TODO App")

Let's create a full-app example that uses automatic CRUD. We'll stick to using the `Task` entity from the previous example, but we'll add a `User` entity and enable [username and password](https://wasp.sh/docs/auth/username-and-pass) based auth.

![Automatic CRUD with Wasp](https://wasp.sh/img/crud-guide.gif)We are building a simple tasks app with username based auth

### Creating the App [​](https://wasp.sh/docs/data-model/crud\#creating-the-app "Direct link to Creating the App")
...
### Adding CRUD to the `Task` Entity ✨ [​](https://wasp.sh/docs/data-model/crud\#adding-crud-to-the-task-entity- "Direct link to adding-crud-to-the-task-entity-")
...
### Our Custom `create` Operation [​](https://wasp.sh/docs/data-model/crud\#our-custom-create-operation "Direct link to our-custom-create-operation")
...
Read more about the default implementations [here](https://wasp.sh/docs/data-model/crud#declaring-a-crud-with-default-options).
...
The `Tasks.CreateAction` type works exactly like the types Wasp generates for [Queries](https://wasp.sh/docs/data-model/operations/queries#type-support-for-queries) and [Actions](https://wasp.sh/docs/data-model/operations/actions#type-support-for-actions).
...
Read more about type support for CRUD overrides in the [API reference](https://wasp.sh/docs/data-model/crud#defining-the-overrides).

### Using the Generated CRUD Operations on the Client [​](https://wasp.sh/docs/data-model/crud\#using-the-generated-crud-operations-on-the-client "Direct link to Using the Generated CRUD Operations on the Client")
...
And here are the login and signup pages, where we are using Wasp's [Auth UI](https://wasp.sh/docs/auth/ui) components:
...
## Future of CRUD Operations in Wasp [​](https://wasp.sh/docs/data-model/crud\#future-of-crud-operations-in-wasp "Direct link to Future of CRUD Operations in Wasp")
...
## API Reference [​](https://wasp.sh/docs/data-model/crud\#api-reference "Direct link to API Reference")
...
### Declaring a CRUD With Default Options [​](https://wasp.sh/docs/data-model/crud\#declaring-a-crud-with-default-options "Direct link to Declaring a CRUD With Default Options")
...
[In the future](https://wasp.sh/docs/data-model/crud#future-of-crud-operations-in-wasp), we are planning to add validation of action input, where only the data that the user is allowed to change will be saved.
...
### Declaring a CRUD With All Available Options [​](https://wasp.sh/docs/data-model/crud\#declaring-a-crud-with-all-available-options "Direct link to Declaring a CRUD With All Available Options")
...
#### Defining the overrides [​](https://wasp.sh/docs/data-model/crud\#defining-the-overrides "Direct link to Defining the overrides")
...
For a usage example, check the [example guide](https://wasp.sh/docs/data-model/crud#adding-crud-to-the-task-entity-).

#### Using the CRUD operations in client code [​](https://wasp.sh/docs/data-model/crud\#using-the-crud-operations-in-client-code "Direct link to Using the CRUD operations in client code")
...
All CRUD operations are implemented with [Queries and Actions](https://wasp.sh/docs/data-model/operations/overview) under the hood, which means they come with all the features you'd expect (e.g., automatic SuperJSON serialization, full-stack type safety when using TypeScript)
...
- [Overview](https://wasp.sh/docs/data-model/crud#overview)
- [Example: A Simple TODO App](https://wasp.sh/docs/data-model/crud#example-a-simple-todo-app)
  - [Creating the App](https://wasp.sh/docs/data-model/crud#creating-the-app)
  - [Adding CRUD to the `Task` Entity ✨](https://wasp.sh/docs/data-model/crud#adding-crud-to-the-task-entity-)
  - [Our Custom `create` Operation](https://wasp.sh/docs/data-model/crud#our-custom-create-operation)
  - [Using the Generated CRUD Operations on the Client](https://wasp.sh/docs/data-model/crud#using-the-generated-crud-operations-on-the-client)
- [Future of CRUD Operations in Wasp](https://wasp.sh/docs/data-model/crud#future-of-crud-operations-in-wasp)
- [API Reference](https://wasp.sh/docs/data-model/crud#api-reference)
  - [Declaring a CRUD With Default Options](https://wasp.sh/docs/data-model/crud#declaring-a-crud-with-default-options)
  - [Declaring a CRUD With All Available Options](https://wasp.sh/docs/data-model/crud#declaring-a-crud-with-all-available-options)
